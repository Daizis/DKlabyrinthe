...
winner = "dklabyrinthe_assets/Winner.png"


# Choix niveau
lvl = "dklabyrinthe_assets/DKaccueil.png"

def func(args):
    return args

# On ouvre la carte du labyrinthe
file = "dklabyrinthe_assets/DK_niveau1.txt"
read = open(file, "r") # on ouvre en lecture
lst = []

liste_carte = read.read().split("\n") # on lit le fichier et on le split au niveau de "\n""
